...
> **[v1.0.0-dev.1](https://github.com/Trimpsuz/morphe-busuu/releases/tag/v1.0.0-dev.1)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;2 patches total
<details open>
...
|----------|----------------|-----------|
| [Spoof premium plus status](#spoof-premium-plus-status) | Spoofs premium plus status |  |
| [Spoof premium status](#spoof-premium-status) | Spoofs premium status |  |
